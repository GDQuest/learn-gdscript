...
onready var _scroll_container := get_node("%ScrollContainer") as ScrollContainer
onready var _scroll_content := get_node("%InnerMargin") as Control
onready var _title := get_node("%Title") as Label
onready var _content_blocks := get_node("%ContentBlocks") as VBoxContainer
onready var _content_container := get_node("%Content") as VBoxContainer
onready var _practices_visibility_container := get_node("%PracticesContainer") as VBoxContainer
onready var _practices_container := get_node("%Practices") as VBoxContainer
