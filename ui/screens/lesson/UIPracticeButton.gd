...
var is_highlighted: bool = false:
	set(value):
		set_is_highlighted(value)

var navigation_disabled: bool = false:
	set(value):
		set_navigation_disabled(value)
...
func setup(practice: Practice, practice_index: int) -> void:
	...
	_navigate_button.pressed.connect(func(): Events.practice_requested.emit(_practice))
