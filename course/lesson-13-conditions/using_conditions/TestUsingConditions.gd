...
func test_statement_1_is_true() -> String:
	...
	if not result:
		return "The first comparison is not correct. Did you use the right comparison?"
	return ""
...
func test_statement_2_is_true() -> String:
	...
	var result = regex.search(_slice.current_text)
	if not result:
		return "The second comparison is not correct. Did you use the right comparison?"
	return ""
...
func test_statement_3_is_true() -> String:
	...
	var result = regex.search(_slice.current_text)
	if not result:
		return "The third comparison is not correct. Did you use the right comparison?"
	return ""
...
func test_statement_4_is_true() -> String:
	...
	var result = regex.search(_slice.current_text)
	if not result:
		return "The fourth comparison is not correct. Did you use the right comparison?"
	return ""
