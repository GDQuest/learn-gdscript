...
def export_platform(platform):
    ...
    generated_gdscript_version_script = f'''# Do not edit this file's data: it is edited automatically by the build CI.
class_name AppVersionMetadata

const git_commit := "{build_info.git_commit}";
const build_date := "{build_info.build_date_iso}";
'''
    Path("utils/app_version_metadata.gd").write_text(generated_gdscript_version_script)
